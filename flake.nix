      ...
      packageOverlays = [
        (
          ...
          _self: super: with super; rec {
            ...
            coverage-local =
              x.upgrade "coverage" "7.6.7"
                "sha256-151IJuQUQcmhGP8EXkvMuf29yx0CQT5+putch7VDnSQ=";

            deepmerge =
              x.upgrade "deepmerge" "2.0"
                "sha256-XD2GCB++vQTdXeA2JqBge4CamPtsy6V3C2JGb+lA/yA=";
            ...
            pytest-cov = x.override "pytest-cov" (pkg: {
              propagatedBuildInputs = x.replace "coverage" pkg.propagatedBuildInputs;
            });
            ...
            typeguard-local =
              x.upgrade "typeguard" "4.4.1"
                "sha256-DSKonQC0U7R8SYdfQrZgG5YXV1QaLh4O9Re24kITwhs=";
